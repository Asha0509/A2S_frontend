    ...
    <section id="features" className="py-20 bg-gradient-to-br from-white via-slate-50 to-gray-100" data-testid="features-section">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold bg-gradient-to-r from-slate-800 via-emerald-600 to-blue-600 bg-clip-text text-transparent mb-4" data-testid="features-title">
